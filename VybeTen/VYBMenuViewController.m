...
- (void)viewDidLoad
{
    ...
    */
    ...
    frame = CGRectMake(0, 0, 150, self.view.bounds.size.width/3);
    ...
    bottomBorder2.frame = CGRectMake(20, self.view.bounds.size.width/3, 110, 1.0f);
    ...
    frame = CGRectMake(0, self.view.bounds.size.width/3, 150, self.view.bounds.size.width/3);
    ...
    bottomBorder3.frame = CGRectMake(20, self.view.bounds.size.width/3, 110, 1.0f);
    ...
    frame = CGRectMake(0, self.view.bounds.size.width*2/3, 150, self.view.bounds.size.width/3);
