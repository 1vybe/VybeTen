...
- (void)drawRect:(CGRect)rect
{
    ...
    CGPathAddArc(arc, NULL, rect.size.width / 2, rect.size.height / 2, smallRadius + thinLineWidth/2, 3 * M_PI_2, 3 * M_PI_2 - self.minPercentage * 4, YES);
    ...
    if (self.passedMin) {
        ...
        CGPathAddArc(arc, NULL, rect.size.width / 2, rect.size.height / 2,
                     smallRadius + thickLineWidth/2, -M_PI_2, -M_PI_2 + M_PI_2 * self.minPercentage * 4, NO);
